...
const DISCORD_ERRORS = {
  ...
  state_expired:        '認証がタイムアウトしました。もう一度お試しください。',
  denied:               'Discord認証がキャンセルされました。',
  token_exchange_failed:'Discordとの通信に失敗しました。',
  user_fetch_failed:    'Discordのユーザー情報を取得できませんでした。',
    ...
    <div className="auth-page">
      <div className="auth-card">
        ...
        <a
          ...
          href="/api/auth/discord_redirect.php"
        >
